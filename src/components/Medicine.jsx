...
const MedicineDetails = () => {
    ...
    return (
        <div className="w-75 mx-auto mt-5">
            ...
            <Link to='/medicines/add' type="button" className="btn btn-outline-success  mb-3">
                    ...
                    <tbody>
                        { medicines?.map((m, index) => (
                            <tr key={m.productId}>
                                ...
                                <td>{m.companyName}</td>
                                <td>
                                    <Link to={`/medicines/update/${m.productId}`} type="button">
                                        <i className="bi bi-pen text-success me-3"></i>
                                    </Link>
                                    <Link to={`/medicines/view/${m.productId}`} type="button">
